<?php
/**
 * Casters.fi - Brand Messages Page
...
<body>
    <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
            <?php $pageTitle = 'Messages'; include '../includes/brand-topbar.php'; ?>
                        ...
                        <div id="chatContent" style="display: none;">
                            <div class="chat-header">
                                ...
                                <div class="chat-header-info">
                                    ...
                                    <p id="chatUserType">Influencer</p>
                                </div>
                            </div>
    ...
    <script>
        ...
        // Load conversations using existing API
